...
- 💼 **Food Delivery Web Application** – Developed a responsive full stack food ordering system with menu, cart, user authentication,                                              and order management using HTML, CSS, JavaScript & Django.
